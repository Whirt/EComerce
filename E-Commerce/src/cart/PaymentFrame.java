...
public class PaymentFrame extends JFrame implements ActionListener {
	...
	private CartTableModel productTable ;
	
	/** This boolean states whether payment succeeded
	 * @param title */
	private static boolean paymentConfirmed = false ;
	
	// Singleton properties
	private static PaymentFrame paymentFrame = null ;
	public static PaymentFrame getPaymentFrame(CartTableModel productTable) {
	...
	private PaymentFrame(String title, CartTableModel productTable) {
		super(title) ;
